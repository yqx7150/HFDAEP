...
params.net1 = loadNet_mri([size(gt),6], use_gpu);%%%%%%%%%%   model
params.gt = gt;

% run EDAEPRec
params.sigma_net1 = 20;   %%%%%%%%%%%%%%%%%%%%%%%   noise_level
params.num_iter = 400;
[map_Rec,psnr_psnr,ssim_ssim,psnr_hfen] = MRIRec_DFPR(Im, degraded, mask, sigma_d, params);
...
save(['./result/' test_save mask_name '_1'],'psnr4','psnr_psnr','ssim_ssim','psnr_hfen','map_Rec');
end
end
