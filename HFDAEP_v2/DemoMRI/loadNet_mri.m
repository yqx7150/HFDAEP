function net1 = loadNet_mri(img_size, use_gpu)
...
net_model = '.\model\deploy_RED_net_DFPR_6D_Mri.prototxt';
% net_weights = '../modelDAEN12_real_3D_lamda12/N12_real3D_iter_200000.caffemodel';
net_weights = '.\model\N20_L1000_200_50_hzn_iter_220000.caffemodel';%%%%%%%%%
FID_base = fopen(net_model, 'r');
Str_base = fread(FID_base, [1, inf]);
fclose(FID_base);
FID_net = fopen('.\model\deploy_RED_net_DFPR_6D_Mri.prototxt', 'w');
