function net1 = loadNet(img_size, use_gpu)
...
net_model = '.\model\deploy_8CRED_net.prototxt';
% net_weights = '../modelDAEN12_real_3D_lamda12/N12_real3D_iter_200000.caffemodel';
net_weights = '.\model\RED_N25_L1000_800_400_50_8C_iter_286725.caffemodel';%%%%%%%%%
FID_base = fopen(net_model, 'r');
Str_base = fread(FID_base, [1, inf]);
fclose(FID_base);
FID_net = fopen('.\model\deploy_8CRED_resized.prototxt', 'w');
fprintf(FID_net, char(Str_base), net_size);
fclose(FID_net);
net_model = '.\model\deploy_8CRED_resized.prototxt';
