function net1 = loadNet_qx3channel_diffSigma111(img_size, use_gpu)
...
%%
net_size = [4, img_size(2), img_size(1)];
...
net_model = '.\model\deploy_4CRED_net.prototxt';
% net_weights = '../modelDAEN12_real_3D_lamda12/N12_real3D_iter_200000.caffemodel';
net_weights = '.\model\N9_L1000_200_200_50_iter_325000.caffemodel';%%%%%%%%%
FID_base = fopen(net_model, 'r');
Str_base = fread(FID_base, [1, inf]);
fclose(FID_base);
FID_net = fopen('.\model\deploy_4CRED_resized.prototxt', 'w');
fprintf(FID_net, char(Str_base), net_size);
fclose(FID_net);
net_model = '.\model\deploy_4CRED_resized.prototxt';
